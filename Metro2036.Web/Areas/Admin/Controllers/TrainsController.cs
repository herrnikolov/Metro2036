...
using Metro2036.Web.Areas.Admin.Models;
...
namespace Metro2036.Web.Areas.Admin.Controllers
{
    public class TrainsController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Maker,Speed,Capacity,Year,ImageUrl,SerialNumber,RouteId")] Train train)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Maker,Speed,Capacity,Year,ImageUrl,SerialNumber,RouteId")] Train train)
        {
            if (id != train.Id)
            {
                return NotFound();
