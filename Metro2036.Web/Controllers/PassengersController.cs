...
namespace Metro2036.Web.Controllers
{
    public class PassengersController : Controller
    {
        ...
        public PassengersController(Metro2036DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TravelId")] Passenger passenger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TravelId")] Passenger passenger)
        {
            if (id != passenger.Id)
            {
                return NotFound();
